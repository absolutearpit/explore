            ...
            <div class="login-box-body">
              ...
              <form method="post">
                ...
                <div class="form-group has-feedback">
                  {{ Form::text('code', null, array('placeholder'=>'Enter code here','class'=>'form-control')) }}
                ...
                <div class="row">
                  ...
                  <div class="col-xs-4">
                    ...
                    {{ Form::submit('Proceed',array('name'=>'proceed','class'=>'btn btn-primary btn-block btn-flat')) }}
                  </div>
                  <!-- /.col -->
                </div>
              </form>
          ...
          ?><div class="login-box">
              ...
              <div class="login-box-body">
                ...
                <form method="post">
                  ...
                  <div class="form-group has-feedback">
                    {{ Form::password('rpassword', array('placeholder'=>'Repeat Password','class'=>'form-control')) }}
                    <span class="glyphicon glyphicon-lock form-control-feedback"></span>
                  </div>
                  <div class="row">
                    <!-- /.col -->
                    <div class="col-xs-4">
                      <!-- <button type="submit" class="btn btn-primary btn-block btn-flat">Sign In</button> -->
                      {{ Form::submit('Reset',array('name'=>'change_password','class'=>'btn btn-primary btn-block btn-flat')) }}
                    </div>
                    <!-- /.col -->
                  </div>
                </form>
