...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ URL::asset('AdminLTE/dist/css/blue.css') }}">
...
<div class="login-box">
    ...
    <form method="post">
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          ...
          {{ Form::submit('login',array('name'=>'login','class'=>'btn btn-primary btn-block btn-flat')) }}
        </div>
        <!-- /.col -->
      </div>
    </form>
  ...
  <div class="register-box-body" style="display: none;">
    ...
    {{csrf_field()}}
      ...
      <div class="form-group has-feedback">
        {{ Form::text('explore_name', null, array('placeholder'=>'Explore Username','class'=>'form-control')) }}
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
      ...
      <div class="row">
        ...
        <div class="col-xs-4">
          ...
          {{ Form::submit('create',array('name'=>'register','id' => 'create','disabled' ,'class' => 'btn btn-primary btn-block btn-flat')) }}
        </div>
        <!-- /.col -->
      </div>
    </form>
  ...
  <div class="forgot-password-box-body" style="display: none;">
    ...
    {{csrf_field()}}
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          {{ Form::submit('submit',array('name'=>'forgot_password','class' => 'btn btn-primary btn-block btn-flat')) }}
        </div>
        <!-- /.col -->
      </div>
    </form>
...
<!-- iCheck -->
<script type="text/javascript" src="{{ URL::asset('AdminLTE/dist/js/icheck.min.js') }}"></script>
