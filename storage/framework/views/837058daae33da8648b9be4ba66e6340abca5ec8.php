            ...
            <div class="navbar-header">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <?php if($exploreName == 'admin'): ?>
                      <li><a href="<?php echo e($root); ?>more">More</a></li>
                    <?php endif; ?>
                    <li>
                    ...
                    <li>
                        <a class="profile-pic" href="<?php echo e($root); ?>profile/<?php echo e($exploreName); ?>"> 
                        <?php if(!empty($avatar)): ?>
                                                ...
                                                <?php $__currentLoopData = $allUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                  <li>
                                                      <div class="call-chat">
                                                          ...
                                                          <button class="btn btn-info btn-circle btn-lg" id="<?php echo e($user['fullname']); ?>:<?php echo e($user['explore_name']); ?>" onClick="openChatWindow(this.id)" type="button"><i class="fa fa-comments-o"></i></button>
                                                      </div>
                                                      <?php $userAvatar = $user['avatar'] ?>
                                                      <a href="/profile/<?php echo e($user['explore_name']); ?>">
                                                      <?php if(!empty($userAvatar)): ?>
                                                        <img src='<?php echo e(URL::asset("images/$userAvatar")); ?>' alt="user-img" class="img-circle"> 
                                                      <?php else: ?>
                                                        <img src='<?php echo e(URL::asset("images/default-avatar.png")); ?>' alt="user-img" class="img-circle"> 
                                                      <?php endif; ?>
                                                        <span><?php echo e($user['fullname']); ?><small class="text-muted">offline</small></span></a>
                                                  </li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                              </ul>
                                          </div>
