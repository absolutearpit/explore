    ...
    <div class="popup_visible" id='popup_visible_custom' style="display: none;">
        <div id="my_popup">
            ...
            <div class="row" >
                ...
                <div class="col-md-6"><?php echo e(Form::button('update',array('name'=>'update_post', 'onClick'=>'updatePost(this.id)', 'class'=>'btn btn-success update_button my_popup_close'))); ?></div>
            </div>
        </div>
    </div>
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li>
                        <a class="profile-pic" href="<?php echo e($root); ?>"> 
                        <?php if(!empty($avatar)): ?>
                ...
                <div class="row">
                    <div class="col-md-4 col-xs-12">
                        <div class="white-box">
                            <div class="user-bg"> 
                            <?php if(empty($cover)): ?>    
                                <img width="100%" alt="user cover" src="<?php echo e(URL::asset('images/default-cover.jpg')); ?>">
                            <?php else: ?>
                                <img width="100%" alt="user cover" src="<?php echo e(URL::asset("images/$cover")); ?>">
                            <?php endif; ?>
                                ...
                                <div class="overlay-box">
                                    <div class="user-content">
                                        ...
                                        <?php if(!empty($avatar)): ?>    
                                            <img src="<?php echo e(URL::asset("images/$avatar")); ?>" class="thumb-lg img-circle" alt="img"></a>
                                        <?php else: ?>
                                            <img src="<?php echo e(URL::asset('images/default-avatar.png')); ?>" class="thumb-lg img-circle" alt="img"></a>
                                        <?php endif; ?>
                                        <h4 class="text-white"><?php echo e($fullName); ?></h4>
                                        <h5 class="text-white"><?php echo e($email); ?></h5> </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4 col-sm-4 text-center">
                                    ...
                                    <h1>
                                        ...
                                        <?php if($values->avatar !== $avatar): ?>
                                            <?php if(isset($status)): ?>
                                                <?php if($status == 1): ?>
                                                    <button id="<?php echo e($userID); ?>" class="btn btn-info" disabled="true">Request Sent</button>
                                                <?php elseif($status == 0): ?>
                                                    <button id="<?php echo e($userID); ?>" disabled="true" class="btn btn-success">Friend</button>
                                                <?php endif; ?>
                                            <?php else: ?>
                                                    <button id="<?php echo e($userID); ?>" class="btn btn-default" onClick='addFriend(this.id)'>Add Friend</button>
                                            <?php endif; ?>
                                        <?php else: ?>
                                            <!-- Nothing to show -->
                                        <?php endif; ?>
                        ...
                        <?php if($values->explore_name == $exploreName): ?>
                            ...
                            <div class="white-box">
                                ...
                                <?php echo e(csrf_field()); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="fullname" placeholder="<?php echo e($fullName); ?>" class="form-control form-control-line"> </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">Explore Name</label>
                                        <div class="col-md-12">
                                            <input type="text" name="explore_name" placeholder="<?php echo e($exploreName); ?>" class="form-control form-control-line"> </div>
                                    </div>                                    
                                    <div class="form-group">
                                        <label for="example-email" class="col-md-12">Email</label>
                                        <div class="col-md-12">
                                            <input type="email" name="email" placeholder="<?php echo e($email); ?>" class="form-control form-control-line" name="example-email" id="example-email"> </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="mobile" placeholder="<?php echo e($mobile); ?>" class="form-control form-control-line"> </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-12">About You</label>
                                        <div class="col-md-12">
                                            <textarea rows="5" name="about" placeholder="<?php echo e($about); ?>" class="form-control form-control-line"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
<!--                                                 <option value="England">England</option>
                                                ...
                                                <?php $__currentLoopData = $allCountry; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $allCountry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <?php if($allCountry == $country): ?>
                                                        <option value="<?php echo e($allCountry); ?>" selected="selected"><?php echo e($allCountry); ?></option>
                                                    <?php else: ?>
                                                        <option value='<?php echo e($allCountry); ?>'><?php echo e($allCountry); ?></option>
                                                    <?php endif; ?>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-6">
                                            <?php echo e(Form::submit('Update Profile',array('name'=>'update_profile','class'=>'btn btn-success'))); ?>

                                        </div>
                                        <div class="col-sm-6">
                                            <?php echo e(Form::submit('Delete Profile',array('name'=>'delete_profile','class'=>'btn btn-success'))); ?>
                        ...
                        <div class="col-md-12 col-xs-12">
                            <div class="white-box">
                                ...
                                <?php if(!empty($about)): ?><p style="text-align: justify; font-size: 12px;"><?php echo e($about); ?></p>
                                <?php else: ?><p style="text-align: justify; font-size: 12px;">Not yet added</p>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php endif; ?>
                    ...
                    <div class="col-md-8 col-xs-12">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <form class="form-horizontal form-material">
                                  ...
                                  <div class="col-md-12">
                                      <?php echo e(Form::textarea('post', null, array('size'=>'30x5','id'=>'post', 'class'=>"form-control form-control-line",'placeholder'=>'Write Here'))); ?>

                                  </div>
                              </div> 
                              <div class="form-group">
                                  <div class="col-md-6">
                                      <?php echo e(Form::button('upload',array('name'=>'upload', 'id'=>'upload_post', 'onClick'=>'uploadPost()', 'class'=>'btn btn-success'))); ?>

                                      <?php echo e(Form::button('cancel',array('name'=>'cancel', 'id'=>'cancel_post', 'onClick'=>'cancelPost()', 'class'=>'btn btn-success'))); ?>
